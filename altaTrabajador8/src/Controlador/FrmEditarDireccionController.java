...
public class FrmEditarDireccionController implements Initializable {
    ...
    public void gestionarEventos(FrmTablaDireccionController tablaDireccionController, String calle, String numexterior, String numinterior, String colonia, String localidad, String estado, String pais){
        txtCalle.setText(calle);
        txtNumExt.setText(numexterior);
        txtNumint.setText(numinterior);
        txtColonia.setText(colonia);
        txtLocalidad.setText(localidad);
        txtEstado.setText(estado);
        txtPais.setText(pais);
        TablaDireccionController = tablaDireccionController;
    }
